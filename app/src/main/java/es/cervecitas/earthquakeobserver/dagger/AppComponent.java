...
@Singleton
@Component(modules = {AppModule.class, PresenterModule.class, NetworkModule.class}) // used to connect objects to their dependencies, typically by use of overridden inject() methods
